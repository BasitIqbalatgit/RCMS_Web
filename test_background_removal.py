#!/usr/bin/env python3
"""
Test script to verify background removal and precise placement functionality.
"""
...
import numpy as np
import os
from stitching import stitch_part_with_background_removal, load_image

def test_background_removal():
    """
    Test background removal and precise placement at YOLO coordinates.
    """
    try:
        ...
        print("=== Testing Background Removal and Placement ===")
        ...
        for i, part in enumerate(data['segmentedParts']):
            ...
            if ref:
                ...
                if ref_img is not None:
                    ...
                    # Test the background removal and placement
                    result_img = stitch_part_with_background_removal(base_img.copy(), ref_img, part)
                    
                    # Save test result
                    test_output = f"test_background_removal_part_{i+1}.jpg"
                    ...
                    ref_output = f"test_reference_part_{i+1}.jpg"
        ...
        print("1. Background removal is working")
